test_that("the registry covers generalized and migrated model combinations", {
    ...
    expected <- data.frame(
        ...
        variant = c(rep("standard", 20), rep("alm", 10)),
        class = c(
            ...
            "PCAIDS", "PCAIDSNests", "LogitBLP", "CournotBLP", "LogitALM", "LogitCournotALM",
        ...
        calibrator = c(
            ...
            "pcaids", "pcaids.nests", "sim", "sim", "logit.alm", "logit.cournot.alm", "ces.alm",
        ...
        calibrate = c(rep(TRUE, 18), FALSE, FALSE, rep(TRUE, 10)),
        specify = c(rep(TRUE, 16), FALSE, FALSE, TRUE, TRUE, rep(FALSE, 10)),
        simulate = rep(TRUE, 30),
