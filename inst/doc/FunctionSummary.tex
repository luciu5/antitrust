...
%\verb@isMarket@& Use the Hypothetical Monopolist Test to \\
%&determine whether a specified set of products is an antitrust market\\
%\verb@smallestMarket@& Use the Hypothetical Monopolist Test to \\
%&identify the smallest candidate antitrust market around one of the
